...
if __name__ == "__main__":
    ...
    test_dataset = TartanAirDataset(
        data_root="TartanAir/TartanAir_shibuya",
    ...
    for ind, sample in enumerate(test_dataloader):
        ...
        track_dir = "results/densetrack_tartanair/pairwise_stride2"
        ...
        schedule = "linear"
        lr = 0.01
        log_dir = f'logdirs/deltav2_pose_est_dust3r/tartanair_withdynamicmask/{vid_name}'
