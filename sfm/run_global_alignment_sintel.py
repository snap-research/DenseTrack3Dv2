...
if __name__ == "__main__":
    ...
    print(f"MPISintel dataset loaded, num samples: {len(test_dataloader)}")
    ...
    for ind, sample in enumerate(test_dataloader):
        ...
        track_dir = "results/densetrack_sintel/pairwise_stride2"
        ...
        schedule = "linear"
        lr = 0.01
        log_dir = f'logdirs/deltav2_pose_est_dust3r/sintel_withdynamicmask/{vid_name}'
        # log_dir = f'logdirs/deltav2_pose_est_dust3r/sintel/{vid_name}'
        ...
        gt_traj = load_traj(
            f"MPI-Sintel/training/camdata_left/{vid_name}",
            "sintel",
            skip=0,
            stride=1,
        )
