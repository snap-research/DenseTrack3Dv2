...
from densetrack3d.models.densetrack3d.upsample_transformer import UpsampleTransformer, UpsampleTransformerAlibi
...
class DenseTrack2DAbs(nn.Module):
    def __init__(
        self,
        window_len=8,
        stride=4,
    ...
    def forward_window(
        ...
        conf_pred = torch.ones_like(vis_pred)  # b s n
