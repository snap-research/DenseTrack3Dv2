    ...
    def scene(self, scene: Scene):
        ...
        for trait_name, setters in self.scene_observers.items():
            ...
            for setter in setters:
                ...
                setter(munch.Munch(new=getattr(scene, trait_name), name=trait_name, owner=scene, type="change"))
    ...
    def add(self, asset: Asset) -> None:
        ...
        for trait_name in asset.trait_names():
            ...
            if isinstance(value, Asset):  # recursively add assets to the
                self.add(value)
            asset.notify_change(munch.Munch(owner=asset, type="change", name=trait_name, new=value, old=value))
