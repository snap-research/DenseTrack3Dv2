...
class Camera(objects.Object3D):
    ...
    def __init__(self, min_render_distance: float = 0.1, max_render_distance: float = 1000.0, **kwargs):
        super().__init__(min_render_distance=min_render_distance, max_render_distance=max_render_distance, **kwargs)
    ...
    def project_point(self, point3d, frame=None):
        ...
        with self.at_frame(frame):
            ...
            point4d = np.concatenate([point3d, [1.0]])
