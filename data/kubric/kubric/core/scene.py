...
from kubric.core.cameras import Camera, UndefinedCamera
...
class Scene(tl.HasTraits):
    ...
    def __init__(
        ...
        gravity: Tuple[float, float, float] = (0, 0, -10.0),
        ...
        super().__init__(
            ...
            gravity=gravity,
            camera=camera,
            ambient_illumination=ambient_illumination,
    ...
    def _valid_step_rate(self, proposal):
        ...
        if proposed_step_rate % self.frame_rate != 0:
            raise tl.TraitError(
                f"step_rate should be a multiple of frame_rate, \
    ...
    def _valid_frame_rate(self, proposal):
        ...
        if self.step_rate % proposed_frame_rate != 0:
            raise tl.TraitError(
                f"step_rate should be a multiple of frame_rate, but \
