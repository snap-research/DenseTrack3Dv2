...
def pose_armature(scene, armature_name: str, frame: float, pose: Dict[str, Dict[str, float]]) -> None:
...
tf.io.gfile.copy(
    "gs://kubric-public/data/pose_estimation/AnimationExample.zip", "examples/KuBasic/AnimationExample.zip"
)
